...
// Using the provided commercial real estate aerial image
import commercialThumbnail from 'figma:asset/dea5953cc93eb20867c5897b95eb04b9cc7b17dd.png';
          ...
          <div className="relative bg-navy/10 aspect-video flex items-center justify-center">
            ...
            <div className="absolute inset-0 bg-black/40 flex items-center justify-center">
              <div className="text-center text-white">
                ...
                <h4 className="font-montserrat-semibold text-xl mb-2">Timelapse Video Portfolio</h4>
                <p className="font-montserrat-regular text-sm opacity-80">
                  Professional commercial real estate timelapses
                </p>
              </div>
            </div>
          </div>
